...
void AJSH_PlayerController::StartRecord()
{
	if (!HasAuthority()) return;
		...
		if (!Recording)
		{
			...
			//FString Params = FString::Printf(TEXT("-f dshow -f gdigrab -offset_x 0 -offset_y 0 -video_size 2560x1600 -framerate 30 -draw_mouse 1 -probesize 1000M -i desktop -c:v h264_nvenc -qp 0 %s.mkv"), *FilePath);
